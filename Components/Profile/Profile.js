    ...
    return (
        <View>
            <View style={{ backgroundColor: color.xanhNhat, height: '42%', width: '100%', borderBottomLeftRadius: 40, borderBottomRightRadius: 40, elevation: 10 }}>
                ...
                />
                <Text style={{ textAlign: 'center', fontSize: 18, fontWeight: 'bold', marginTop: 10 }}>Khất Phi Long</Text>
                <Text style={{ textAlign: 'center', fontStyle: 'normal', fontSize: 15 }}>Hello9999@gmail.com</Text>
            </View>
            ...
            <View style={{
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Text style={{ textAlign: 'center', marginEnd: '5%', marginTop: 30 }}>kiencancuem</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Text style={{ textAlign: 'center', marginEnd: '5%', marginTop: 30 }}>Change</Text>
                </View>
