...
const TrangChu = (props) => {
  ...
  return (
    <View>
      <View style={{paddingLeft:10,backgroundColor:"#584CF4",paddingBottom:10,paddingTop:40,flexDirection:'row',alignItems:'center'}}>
        <Image
        source={{
      ...
      <View style={{padding:10,marginTop:20}}>
        <View style={{flexDirection:'row'}}>
          ...
          />
          <Text style={{fontWeight:'bold',color:color.xanh}}>Báo cáo doanh thu</Text>
        </View>
        <View style={{marginTop:10,backgroundColor:'white',paddingVertical:10,borderRadius:10,paddingHorizontal:10}}>
          <View style={{flexDirection:'row'}}>
            <Text style={{fontSize:20,color:color.xanh,flex:1}}>Hôm nay</Text>
            <View style={{}}>
          ...
          <View style={{flexDirection:'row'}}>
            <Text style={{fontSize:20,color:color.xanh,flex:1}}>Tháng này</Text>
            <Text style={{color:'gray'}}>{getDate}</Text>
          </View>
          <View style={{flexDirection:'row',marginTop:5}}>
            <Text style={{fontSize:40}}>12311234</Text>
